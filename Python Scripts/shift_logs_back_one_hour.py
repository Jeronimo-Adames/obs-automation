#!/usr/bin/env python3
"""Move each log CSV timestamp and filename back by one hour.
...
MANIFEST_NAME = "shift_logs_back_one_hour_manifest.csv"
...
def main() -> int:
    ...
    print(f"Folder: {root}")
    print("Action: shift log filenames and CSV timestamps back by 1 hour")
